pipeline {
    ...
    parameters {
        choice (name: 'AwsCredentialId', choices: ['AWS-DEV-D1', 'AWS-DR-Deploy', 'AWS-PROD-Deploy'], description: 'Choose AWS ENV Where you Creating this AMI')
    }
    stages {
...
export BUILDAMI_PROFILE='Staging-ec2-role'
EOF
                            ;;
                        AWS-DR-*)
                            cat - > aws.env <<EOF
...
'''
        ...
        stage('Prepare AMI') {
            steps {
                checkout([$class: 'GitSCM', branches: [[name: '${Branch}']], doGenerateSubmoduleConfigurations: false, extensions: [[$class: 'RelativeTargetDirectory', relativeTargetDir: 'src']], submoduleCfg: [], userRemoteConfigs: [[credentialsId: '0b5c6ad2-f499-4557-8c8d-c944df92c407', name:'origin', refspec:'+refs/heads/*:refs/remotes/origin/* +refs/tags/*:refs/tags/* ${Refspec}', url: 'https://github.com/tunglouis/ami-base.git']]])
